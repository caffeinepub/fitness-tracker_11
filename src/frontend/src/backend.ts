...
import type { ProgressStats as _ProgressStats, UserProfile as _UserProfile, UserRole as _UserRole, WorkoutHistory as _WorkoutHistory } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createWorkoutPlan(arg0: string, arg1: bigint, arg2: Array<Array<WorkoutEntry>>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createWorkoutPlan(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkoutHistory(): Promise<WorkoutHistory | null> {
        if (this.processError) {
            try {
    ...
    async logWorkout(arg0: Array<WorkoutEntry>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WorkoutHistory]): WorkoutHistory | null {
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProgressStats]): ProgressStats | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        fitnessGoal: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.fitnessGoal)),
        name: value.name,
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        fitnessGoal: value.fitnessGoal ? candid_some(value.fitnessGoal) : candid_none(),
        name: value.name,
